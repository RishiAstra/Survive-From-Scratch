...
Shader "New Amplify Shader"
{
	Properties
	{
		...
		[ASEBegin]_Color("Color", 2D) = "white" {}
		[ASEEnd][Normal]_Normal("Normal", 2D) = "bump" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float localBicubicPrepare2_g1 = ( 0.0 );
				float2 uv_Color = IN.ase_texcoord7.xy * _Color_ST.xy + _Color_ST.zw;
				float2 Input_UV100_g1 = uv_Color;
				float2 UV2_g1 = Input_UV100_g1;
				float4 TexelSize2_g1 = _Color_TexelSize;
				float2 UV02_g1 = float2( 0,0 );
				...
				{
				{
				 UV2_g1 = UV2_g1 * TexelSize2_g1.zw - 0.5;
				    float2 f = frac( UV2_g1 );
				    UV2_g1 -= f;
				 ...
				 float4 yc = float4( yv.xyz, 6.0 - yv.x - yv.y - yv.z );
				    float4 c = float4( UV2_g1.x - 0.5, UV2_g1.x + 1.5, UV2_g1.y - 0.5, UV2_g1.y + 1.5 );
				    float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
				    float4 off = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize2_g1.xyxy;
				    UV02_g1 = off.xz;
				    UV12_g1 = off.yz;
				    UV22_g1 = off.xw;
				    UV32_g1 = off.yw;
				...
				float4 lerpResult46_g1 = lerp( tex2D( _Color, UV32_g1 ) , tex2D( _Color, UV22_g1 ) , W02_g1);
				float4 lerpResult45_g1 = lerp( tex2D( _Color, UV12_g1 ) , tex2D( _Color, UV02_g1 ) , W02_g1);
				float4 lerpResult44_g1 = lerp( lerpResult46_g1 , lerpResult45_g1 , W12_g1);
				float4 Output_2D131_g1 = lerpResult44_g1;
				
				float localBicubicPrepare2_g4 = ( 0.0 );
				float2 uv_Normal = IN.ase_texcoord7.xy * _Normal_ST.xy + _Normal_ST.zw;
				float2 Input_UV100_g4 = uv_Normal;
				float2 UV2_g4 = Input_UV100_g4;
				float4 TexelSize2_g4 = _Normal_TexelSize;
				float2 UV02_g4 = float2( 0,0 );
				...
				{
				{
				 UV2_g4 = UV2_g4 * TexelSize2_g4.zw - 0.5;
				    float2 f = frac( UV2_g4 );
				    UV2_g4 -= f;
				    float4 xn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.xxxx;
				    float4 yn = float4( 1.0, 2.0, 3.0, 4.0 ) - f.yyyy;
				    float4 xs = xn * xn * xn;
				    ...
				    float4 xc = float4( xv.xyz, 6.0 - xv.x - xv.y - xv.z );
				 float4 yc = float4( yv.xyz, 6.0 - yv.x - yv.y - yv.z );
				    float4 c = float4( UV2_g4.x - 0.5, UV2_g4.x + 1.5, UV2_g4.y - 0.5, UV2_g4.y + 1.5 );
				    float4 s = float4( xc.x + xc.y, xc.z + xc.w, yc.x + yc.y, yc.z + yc.w );
				    float4 off = ( c + float4( xc.y, xc.w, yc.y, yc.w ) / s ) * TexelSize2_g4.xyxy;
				    UV02_g4 = off.xz;
				    UV12_g4 = off.yz;
				    UV22_g4 = off.xw;
				    UV32_g4 = off.yw;
				...
				float4 lerpResult46_g4 = lerp( tex2D( _Normal, UV32_g4 ) , tex2D( _Normal, UV22_g4 ) , W02_g4);
				float4 lerpResult45_g4 = lerp( tex2D( _Normal, UV12_g4 ) , tex2D( _Normal, UV02_g4 ) , W02_g4);
				float4 lerpResult44_g4 = lerp( lerpResult46_g4 , lerpResult45_g4 , W12_g4);
				float4 Output_2D131_g4 = lerpResult44_g4;
				
				float3 Albedo = Output_2D131_g1.rgb;
				float3 Normal = Output_2D131_g4.rgb;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = 0;
...
/*ASEBEGIN
Version=18800
316;73;958;443;815.3454;209.9034;1.784647;True;True
Node;AmplifyShaderEditor.TexturePropertyNode;6;-419.6133,-83.1666;Inherit;True;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FunctionNode;7;-72.25627,-101.9082;Inherit;False;Bicubic Sample;-1;;1;ce0e14d5ad5eac645b2e5892ab3506ff;2,92,0,72,0;7;99;SAMPLER2D;0;False;91;SAMPLER2DARRAY;0;False;93;FLOAT;0;False;97;FLOAT2;0,0;False;198;FLOAT4;0,0,0,0;False;199;FLOAT2;0,0;False;94;SAMPLERSTATE;0;False;5;COLOR;86;FLOAT;84;FLOAT;85;FLOAT;82;FLOAT;83
Node;AmplifyShaderEditor.TexturePropertyNode;9;-413.2733,121.1261;Inherit;True;Property;_Normal;Normal;1;1;[Normal];Create;True;0;0;0;False;0;False;None;None;False;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FunctionNode;12;-68.29971,79.2601;Inherit;False;Bicubic Sample;-1;;4;ce0e14d5ad5eac645b2e5892ab3506ff;2,92,0,72,0;7;99;SAMPLER2D;0;False;91;SAMPLER2DARRAY;0;False;93;FLOAT;0;False;97;FLOAT2;0,0;False;198;FLOAT4;0,0,0,0;False;199;FLOAT2;0,0;False;94;SAMPLERSTATE;0;False;5;COLOR;86;FLOAT;84;FLOAT;85;FLOAT;82;FLOAT;83
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;313.3046,-7.958069;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
WireConnection;7;99;6;0
WireConnection;7;94;6;1
WireConnection;12;99;9;0
WireConnection;12;94;9;1
WireConnection;1;0;7;86
WireConnection;1;1;12;86
ASEEND*/
//CHKSM=FE0E4120BC79609FA1CA67312BFF99F20B765FF0