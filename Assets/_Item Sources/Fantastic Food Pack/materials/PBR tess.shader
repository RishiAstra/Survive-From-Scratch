...
Shader "PBR tess"
{
	Properties
	{
		...
		[ASEEnd]_NormalMap("Normal Map", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_MetalicMap = IN.ase_texcoord7.xy * _MetalicMap_ST.xy + _MetalicMap_ST.zw;
				float4 tex2DNode8 = tex2D( _MetalicMap, uv_MetalicMap );
				
				float3 Albedo = tex2D( _BaseMap, uv_BaseMap ).rgb;
				float3 Normal = tex2D( _NormalMap, uv_NormalMap ).rgb;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = tex2DNode8.r;
				float Smoothness = ( tex2DNode8.a * _Smoothness );
				float Occlusion = 1;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18800
492;73;1027;569;939.2045;225.4397;1.3;True;True
Node;AmplifyShaderEditor.SamplerNode;8;-555.1605,-7.300507;Inherit;True;Property;_MetalicMap;Metalic Map;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;7;-413.1605,-315.3005;Inherit;True;Property;_BaseMap;Base Map;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;9;-496.1605,-157.3005;Inherit;True;Property;_NormalMap;Normal Map;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;6;-507.2599,250.2997;Inherit;False;Property;_Smoothness;Smoothness;0;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-213.8045,159.3603;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=578D1790B5B76BA9E9AC7B5F52FB81989B0F53CC